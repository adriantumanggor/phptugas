...
if (isset($_GET['id'])) {
    ...
    if (mysqli_num_rows($result_check) > 0) {
        ...
        if (isset($_POST['submit'])) {
            ...
            $query = "UPDATE anggota SET nama='$nama', email='$email', nrp='$nrp', jenis_kelamin='$jenis_kelamin', jurusan='$jurusan', alamat='$alamat', no_hp='$no_hp', asal_sma='$asal_sma', mata_kuliah_favorit='$mata_kuliah_favorit', hoki='$hoki' WHERE id=$id";
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="field is-horizontal">
                            ...
                            <div class="field-body">
                                <div class="field">
                                    <p class="control is-expanded">
                                        <textarea class="textarea" name="hoki"><?php echo $data['hoki']; ?></textarea>
                                    </p>
                                </div>
                            </div>
                        </div>
